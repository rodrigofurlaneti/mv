...
namespace InitializerHelper.Startup
{
    public static class PessoaStartup
    {
        ...
        private static void AdicionaPessoaRoot()
        {
            ...
            {
                Nome = "Carlos Fernandes Lima",
                Sexo = "Masculino",
                DataNascimento = new DateTime(1988, 12, 23),
                Documentos = new List<Documento> { new Documento { Numero = "12345678900", Tipo = 2 } },
                Contatos = new List<PessoaContato>()
            };

            pessoa.Contatos.Add(new PessoaContato { Contato = new Contato { Numero = "11983102020", Tipo = TipoContato.Celular, NomeRecado = "Dom João" } });
            pessoa.Contatos.Add(new PessoaContato { Contato = new Contato { Email = "leandrogrando@leojarts.com.br", Tipo = TipoContato.Email } });
            ...
            var endereco = new Endereco
            {
                ...
                Numero = "682",
                Tipo = 2,
                Complemento = "Loja 100",
                Descricao = "Loja",
                Latitude = "-23.6201940",
                Longitude = "-46.6983960",
                Cidade = cidade,
                Pessoa = pessoa
            };

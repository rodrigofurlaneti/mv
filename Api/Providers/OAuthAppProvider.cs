    ...
    public class OAuthAppProvider : OAuthAuthorizationServerProvider
    {
        ...
        public static AuthenticationProperties CreateProperties(Usuario usuario, string clientId)
        {
            IDictionary<string, string> data = new Dictionary<string, string>
            {
                ...
                { "Convenio", usuario.ListaUsuarioConvenio != null && usuario.ListaUsuarioConvenio.Any() ? usuario.ListaUsuarioConvenio.FirstOrDefault().Convenio.Descricao : string.Empty },
                { "Combo", usuario.ListaUsuarioCombo != null && usuario.ListaUsuarioCombo.Any() ? usuario.ListaUsuarioCombo.FirstOrDefault().PlanoVenda.Descricao : string.Empty }
            };

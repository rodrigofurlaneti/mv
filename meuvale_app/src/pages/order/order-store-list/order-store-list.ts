...
export class OrderStoreListPage {
  ...
  carregarPedidos(force: boolean = false) {
    this.utils.showLoader("carregando pedidos...");
    this.orderProvider.listByStore(this.loja.Id, this._page, 10)
      .subscribe(
        data => {
          ...
          if (force)
            ...
            this.listaPedidos = this.listaPedidos.concat(data);

...
namespace Core.Extensions
{
    public static class StringExtension
    {
        ...
        /// <summary>
        ///     Returns a new string that right-aligns the characters in this intance by padding them with spaces on the left, for
        ...
        /// </param>
        /// <returns></returns>
        public static string PadLeftTrunc(this string text, int totalWidth)
        {
            string value = text;

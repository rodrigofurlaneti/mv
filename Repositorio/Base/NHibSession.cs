...
namespace Repositorio.Base
{
    public class NHibSession
    {
        ...
        {
            return NHibContext.InnerSession.BeginTransaction();
        }
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public IList<T> GetList<T>(int firstResult, int maxResult, string entityOrderBy, string columnOrderBy) where T : class, IEntity
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public IList<T> GetList<T>(int firstResult, int maxResult, string entityOrderBy, string columnOrderBy, params ICriterion[] criterions) where T : class, IEntity
        {
        ...
        /// <returns></returns>
        public IList<T> GetListByCriterionsByInterval<T>(int firstResult, int maxResult, string entityOrderBy, string columnOrderBy, params ICriterion[] criterions) where T : class, IEntity
        {
        ...
        public void DeleteByQuery(string query)
        {
            using (ITransaction trans = NHibContext.InnerSession.BeginTransaction())
            {
                NHibContext.InnerSession.CreateSQLQuery(query).ExecuteUpdate();
                trans.Commit();
            }
        }
        ...
        public void Save<T>(IList<T> obj) where T : class, IEntity
        {
            ...
            {
                NHibContext.InnerSession.Save(NHibContext.InnerSession.Merge(t));
                NHibContext.InnerSession.Clear();
            }
        }

        /// <summary>
        /// Delete a list of items matching sent expression.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="query">The query.</param>
        /// <returns></returns>
        public void DeleteBy<T>(Expression<Func<T, bool>> query) where T : class, IEntity
        {
            using (var trans = NHibContext.InnerSession.BeginTransaction())
            {
                NHibContext.InnerSession.Delete(NHibContext.InnerSession.Merge(NHibContext.InnerSession.Query<T>().Where(query).ToList()));
                trans.Commit();
            }
        }
    }
